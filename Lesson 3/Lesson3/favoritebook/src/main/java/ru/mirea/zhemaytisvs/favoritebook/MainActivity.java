package ru.mirea.zhemaytisvs.favoritebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOpenInput.setOnClickListener(v -> {
            ...
            intent.putExtra(BOOK_NAME_KEY, "Лирика Хованского");
            intent.putExtra(QUOTES_KEY, "Слова могут ранить как пули. А знаешь, что ещё может ранить как пули?.. Пули!");
